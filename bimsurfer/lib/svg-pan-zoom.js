...
SvgPanZoom.prototype.setupHandlers = function() {
  ...
  for (var event in this.eventListeners) {
    ...
    (this.options.eventsListenerElement || this.svg).addEventListener(
      ...
      this.options.preventMouseEventsDefault ? activeListenerOption : passiveListenerOption
    );
  }
...
module.exports = (function(){
  ...
  var activeOption = {passive: false};
  ...
  function _addWheelListener(elem, eventName, callback, isPassiveListener ) {
    ...
    elem[_addEventListener](prefix + eventName, cb, isPassiveListener ? passiveOption : activeOption);
  }
  ...
  function _removeWheelListener(elem, eventName, callback, isPassiveListener ) {
    ...
    elem[_removeEventListener](prefix + eventName, cb, isPassiveListener ? passiveOption : activeOption);
